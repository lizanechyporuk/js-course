...
console.log(Number.parseFloat(" 25rem  "));
...
// Math random
console.log(Math.trunc(Math.random() * 6) + 1); // including 6

// Random generalized
const randomInt = (min, max) =>
  Math.floor(Math.random() * (max - min) + 1) + min; // 0...1 -> 0....(max - min) -> min....(max - min + min) -> min...max
...
console.log((2.345).toFixed(2)); // 2.35 -str
...
console.log(36286372637263726376237263372632n * 10000000n);
...
console.log(now);
// 2)
console.log(new Date("Oct 30 2023 16:14:44"));
